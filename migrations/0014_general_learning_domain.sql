...
CREATE TABLE `outcome_kcs` (
	...
	FOREIGN KEY (`outcome_id`) REFERENCES `course_outcomes`(`id`) ON UPDATE no action ON DELETE cascade,
...
CREATE TABLE `example_kcs` (
	...
	FOREIGN KEY (`example_id`) REFERENCES `kc_examples`(`id`) ON UPDATE no action ON DELETE cascade,
	FOREIGN KEY (`kc_id`) REFERENCES `kcs`(`id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
...
CREATE TABLE `reference_kcs` (
	...
	FOREIGN KEY (`reference_id`) REFERENCES `course_references`(`id`) ON UPDATE no action ON DELETE cascade,
	FOREIGN KEY (`kc_id`) REFERENCES `kcs`(`id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
